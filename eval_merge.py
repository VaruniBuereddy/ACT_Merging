...
from composite_model import CompositeNetwork
...
checkpoint_dir = '/home/varuni/Documents/Researchwork/act/merged_ckpts/task_ids_1_100_1'
...
if __name__ == "__main__":
    ...
    task_dict = {'close_drawer': [1000], 'pick_goal':[100]}
    ...
    composite_policy.load_state_dict(torch.load(ckpt_path, map_location=torch.device(device)))

    print(f'Loaded: {ckpt_path}')
    # checkpoint_dir = os.path.join(checkpoint_dir, 'FFN')
        ...
        with torch.inference_mode():
            ...
            for t in range(cfg['episode_len']):
                ...
                if t % query_frequency == 0:
                    all_actions = composite_policy(*[qpos, curr_image.to(device), None, None, task_id.to(device)])
