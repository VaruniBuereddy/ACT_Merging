...
class CompositeNetwork(nn.Module):
    def __init__(self, model1, model2, intermediate_dim=1024):
...
if __name__ =='__main__':
    ...
    checkpoint_dir = CHECKPOINT_DIR #os.path.join(train_cfg['checkpoint_dir'], task)
    ...
    checkpoint1_path = '/home/varuni/Documents/Researchwork/AdaMerging/checkpoints/ACT/close_drawer'
    checkpoint2_path = '/home/varuni/Documents/Researchwork/AdaMerging/checkpoints/ACT/pick_goal'
    ...
    # print(torch.load(os.path.join(checkpoint2_path, 'policy_last.ckpt'))['model.pos_table'].shape)
    # policy1.eval()
    # policy2.eval()
    ...
    train_dataloader, val_dataloader, stats, _ = load_data(data_dir, num_episodes, task_cfg['camera_names'],
                                                                train_cfg['batch_size_train'], train_cfg['batch_size_val'], task_id=1)
